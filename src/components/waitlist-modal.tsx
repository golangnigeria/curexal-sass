...
export function WaitlistModal({ open, onOpenChange }: WaitlistModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={resetAndClose}>
      <DialogContent className="max-w-lg w-[94vw] sm:w-full bg-white dark:bg-[#0B1120] border border-slate-200 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-2xl z-[999999] max-h-[88dvh] overflow-y-auto font-inter">
        {!submitted && (
          <DialogHeader className="space-y-1.5 text-left pb-2.5 border-b border-slate-100 dark:border-slate-800">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-6 rounded-lg bg-teal-50 dark:bg-teal-950/60 border border-teal-200 dark:border-teal-800 flex items-center justify-center text-[#0F766E] dark:text-teal-400 font-bold text-[10px]">
                  {step}/6
                </div>
        ...
        {submitted ? (
          <div className="py-2 space-y-4 animate-in fade-in zoom-in-95 duration-200">
            {/* Confirmation Banner */}
            <div className="p-4 sm:p-5 rounded-2xl bg-teal-50/90 dark:bg-teal-950/40 border border-teal-200/80 dark:border-teal-800/80 text-center space-y-2">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 max-w-xs mx-auto leading-relaxed">
                Thank you for registering as a <strong className="text-[#0F766E] dark:text-teal-300">{persona}</strong>. Your vote directly impacts our launch roadmap.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-slate-400 font-medium">Click to upvote</span>
              </div>
              ...
              <div className="space-y-2">
                {DEFAULT_ROADMAP_VOTES.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 flex items-center justify-between gap-2 shadow-xs"
                    >
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 mb-0.5">
                          <span className="text-[9px] font-extrabold uppercase text-[#0F766E] dark:text-teal-400 bg-teal-50 dark:bg-teal-950/80 px-1 py-0.2 rounded">
                            {item.category}
                          </span>
                          <span className="text-[10px] text-slate-400">{item.percent}% demand</span>
                        </div>
            ...
            <div className="pt-2 flex items-center gap-2">
              <Button
                ...
                variant="outline"
                className="w-1/2 h-10 text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 border-slate-200 dark:border-slate-800"
              >
              ...
              <Button
                ...
                className="w-1/2 bg-[#0F766E] hover:bg-[#115E59] text-white font-bold h-10 text-xs rounded-xl"
              >
                Done
              </Button>
            </div>
          ...
          <form onSubmit={handleSubmit} className="py-2 space-y-3.5" noValidate>
            ...
            {step === 1 && (
              <div className="space-y-3">
                  ...
                  {PERSONAS.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-2.5 sm:p-3 rounded-xl border text-[11px] font-bold transition-all cursor-pointer ${
                          active
                ...
                <Button
                  type="button"
                  onClick={() => setStep(2)}
                  className="w-full bg-[#0F766E] hover:bg-[#115E59] text-white font-bold h-10 text-xs rounded-xl mt-3 flex items-center justify-center gap-1.5"
                >
                  <span>Continue</span>
            ...
            {step === 4 && (
              <div className="space-y-3">
                ...
                <div className="space-y-1.5 max-h-[48dvh] overflow-y-auto pr-1">
            ...
            {step === 6 && (
              <div className="space-y-3">
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Would you like to help shape Curexal's early release?
                </p>
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`w-full p-2.5 rounded-xl border text-xs font-bold text-left transition-all cursor-pointer flex items-center justify-between gap-2 ${
                          active
                            ? "bg-teal-50 dark:bg-teal-950/60 text-[#0F766E] dark:text-teal-300 border-[#0F766E]"
                            : "bg-slate-50 dark:bg-slate-900/60 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-800 hover:border-slate-300"
                        }`}
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#0F766E] hover:bg-[#115E59] text-white font-bold h-11 text-xs rounded-xl shadow-lg transition-all flex items-center justify-center gap-1.5 mt-3 cursor-pointer"
                >
                ...
                <p className="text-[10px] text-center text-slate-400 flex items-center justify-center gap-1 pt-1">
                  ...
                  <span>Zero spam. HIPAA & NDPR data privacy guaranteed.</span>
                </p>
              </div>
            )}
          </form>
